customElements.define("my-info", class extends HTMLElement {
  ...
  render(prop, oldVal, newVal) {
    if (this.visibility) {
      ...
      this.shadowRoot.innerHTML = `
      <button style="margin:0.5em 0;cursor:pointer;font-size:0.9em;box-shadow: 0px 0px 2px 1px rgb(204, 11, 11);border:none;background:#333b;color:#a5a5a5;padding:3px 16px 6px;">About Me</button>
      `;
    }
  }
});
